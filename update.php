...
<div>
학과
<input type="radio" name="major" value="뷰티디자인과" <?php if($majorprt == "뷰티디자인과") echo "checked"; ?> >뷰티디자인과
<input type="radio" name="major" value="부사관과" <?php if($majorprt == "부사관과") echo "checked"; ?> >부사관과
<input type="radio" name="major" value="금융경영과" <?php if($majorprt == "금융경영과") echo "checked"; ?> >금융경영과
<input type="radio" name="major" value="회계정보과" <?php if($majorprt == "회계정보과") echo "checked"; ?> >회계정보과
...
<input type="radio" name="major" value="소프트웨어개발과" <?php if($majorprt == "소프트웹어개발과") echo "checked"; ?> >소프트웨어개발과
</div>
<div>
주소
<select name="addr">
